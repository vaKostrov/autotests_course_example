...
def treatment_sum(our_tuple: tuple):
    """
    Функция принимает на вход кортеж our_tuple и производит проверку:
    Если в кортеже 2 элемента и их можно сложить - возвращает получившийся результат;
    Если в кортеже 2 элемента и их нельзя сложить - обрабатывает исключение и возвращает строку
    'Нельзя сложить эти данные';
    ...
    :param our_tuple: кортеж с входными данными,
