...
def generate_random_name():
    """
    Функция формирует алфавит из доступных для использования символов
    и генерирует с помощью random 2 слова из букв сформированного алфавита длиной от 1 до 15
    """
